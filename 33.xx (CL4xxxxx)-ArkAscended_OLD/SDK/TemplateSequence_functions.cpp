...
// Parameters:
// class UTemplateSequence*           InSequence                                                       (Edit, BlueprintVisible, ExportObject, EditFixedSize, OutParm, ZeroConstructor, ReturnParm, DisableEditOnInstance, InstancedReference, SubobjectReference)
...
// bool                               bOverridesDefault                                                (Edit, ConstParm, ExportObject, Net, Parm, ZeroConstructor, ReturnParm, Transient, Config, InstancedReference, SubobjectReference)
...
// Parameters:
// class UTemplateSequence*           ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class UTemplateSequencePlayer*     ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
...
// class ATemplateSequenceActor*      OutActor                                                         (Edit, BlueprintVisible, Net, ZeroConstructor, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
// class UTemplateSequencePlayer*     ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)

class ATemplateSequenceActor* UTemplateSequencePlayer::CreateTemplateSequencePlayer(class UTemplateSequence** TemplateSequence, class UTemplateSequencePlayer** ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// int32                              PPIndex                                                          (Edit, ConstParm, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
// struct FPostProcessSettings        OutPPSettings                                                    (Edit, ConstParm, BlueprintReadOnly, Net, ZeroConstructor, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
// float                              OutPPBlendWeight                                                 (ConstParm, ExportObject, Net, ZeroConstructor, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
// bool                               ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)

float USequenceCameraShakeTestUtil::GetPostProcessBlendCache(class APlayerController** PlayerController, bool* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class APlayerController*           PlayerController                                                 (Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, Parm, OutParm, ZeroConstructor, GlobalConfig)
// struct FMinimalViewInfo            ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)

void USequenceCameraShakeTestUtil::GetLastFrameCameraCachePOV(class APlayerController** PlayerController, struct FMinimalViewInfo* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void USequenceCameraShakeTestUtil::GetCameraCachePOV(class APlayerController** PlayerController, struct FMinimalViewInfo* ReturnValue)
{
	static class UFunction* Func = nullptr;
