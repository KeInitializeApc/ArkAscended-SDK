...
bool UUI_CustomizeSlot_SideBar_C::SetColor(struct FLinearColor* Color)
{
...
void UUI_CustomizeSlot_SideBar_C::GetColor(struct FLinearColor* Color, const struct FCFCoreThemeRowData& CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
