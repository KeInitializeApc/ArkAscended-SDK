...
class UClass* UHuman_Male_TPV_OrientationWarping_CtrlRig_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Human_Male_TPV_OrientationWarping_CtrlRig_C");

	return Clss;
}


// Human_Male_TPV_OrientationWarping_CtrlRig_C Human_Male_TPV_OrientationWarping_CtrlRig.Default__Human_Male_TPV_OrientationWarping_CtrlRig_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHuman_Male_TPV_OrientationWarping_CtrlRig_C* UHuman_Male_TPV_OrientationWarping_CtrlRig_C::GetDefaultObj()
{
	static class UHuman_Male_TPV_OrientationWarping_CtrlRig_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHuman_Male_TPV_OrientationWarping_CtrlRig_C*>(UHuman_Male_TPV_OrientationWarping_CtrlRig_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal Human_Male_TPV_OrientationWarping_CtrlRig.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work Human_Male_TPV_OrientationWarping_CtrlRig.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
