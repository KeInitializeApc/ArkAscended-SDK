...
class UClass* UHuman_FixVB_CtrlRig_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Human_FixVB_CtrlRig_C");

	return Clss;
}


// Human_FixVB_CtrlRig_C Human_FixVB_CtrlRig.Default__Human_FixVB_CtrlRig_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHuman_FixVB_CtrlRig_C* UHuman_FixVB_CtrlRig_C::GetDefaultObj()
{
	static class UHuman_FixVB_CtrlRig_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHuman_FixVB_CtrlRig_C*>(UHuman_FixVB_CtrlRig_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal Human_FixVB_CtrlRig.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work Human_FixVB_CtrlRig.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
