...
// class UGLTFExportOptions*          Options                                                          (Edit, ConstParm, EditFixedSize, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, GlobalConfig, SubobjectReference)
// TSet<class AActor*>                SelectedActors                                                   (Edit, ConstParm, ExportObject, BlueprintReadOnly, Net, EditFixedSize, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
// struct FGLTFExportMessages         OutMessages                                                      (BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
// bool                               ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)

class UGLTFExportOptions* UGLTFExporter::ExportToGLTF(class UObject** Object, const class FString& FilePath, TSet<class AActor*>* SelectedActors, struct FGLTFExportMessages* OutMessages, bool* ReturnValue)
{
	static class UFunction* Func = nullptr;
