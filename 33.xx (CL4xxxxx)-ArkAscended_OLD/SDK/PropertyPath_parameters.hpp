...
{
public:
	struct FPropertyPathTestStruct               InStruct;                                          // 0x0(0x50)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InFloat;                                           // 0x0(0x4)(Edit, ConstParm, Net, Parm, OutParm, ReturnParm, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
{
public:
	struct FPropertyPathTestStruct               ReturnValue;                                       // 0x0(0x50)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
