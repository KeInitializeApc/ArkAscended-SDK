...
public:
	...
	uint8                                        Pad_20DF[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	struct FImageWriteOptions                    Options;                                           // 0x20(0x60)(Edit, ConstParm, EditFixedSize, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, GlobalConfig, SubobjectReference)
};
