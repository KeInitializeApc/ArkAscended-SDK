...
public:
	...
	class FString                                Desc;                                              // 0x10(0x10)(Edit, ConstParm, ExportObject, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_2127[0x8];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	struct FSoftObjectPath                       Thumbnail;                                         // 0x0(0x20)(ConstParm, BlueprintVisible, ExportObject, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
