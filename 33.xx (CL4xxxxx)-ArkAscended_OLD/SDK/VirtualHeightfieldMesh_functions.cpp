...
// Parameters:
// bool                               InOutHidePrimitivesInEditor                                      (Edit, ConstParm, EditFixedSize, Parm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
// bool                               InOutHidePrimitivesInGame                                        (Edit, BlueprintVisible, BlueprintReadOnly, Net, Parm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
...
void UVirtualHeightfieldMeshComponent::GatherHideFlags(bool InOutHidePrimitivesInEditor, bool InOutHidePrimitivesInGame)
{
	...
	Parms.InOutHidePrimitivesInEditor = InOutHidePrimitivesInEditor;
	Parms.InOutHidePrimitivesInGame = InOutHidePrimitivesInGame;
