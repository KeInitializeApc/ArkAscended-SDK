...
{
public:
	class UStaticMesh*                           SourceMesh;                                        // 0x0(0x8)(ConstParm, ExportObject, BlueprintReadOnly, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	class UTexture2D*                            SourceTexture;                                     // 0x8(0x8)(ConstParm, BlueprintReadOnly, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	int32                                        SourceTextureUVLayer;                              // 0x10(0x4)(Edit, ConstParm, BlueprintVisible, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_18A9[0x4];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	class UCombinedTransformGizmo*               TransformGizmo;                                    // 0x8(0x8)(Net, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_18B0[0xC];                                     // Fixing Size After Last Property  > TateDumper <
...
{
public:
	struct FVector                               Dimensions;                                        // 0x0(0x18)(Edit, BlueprintVisible, ExportObject, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, DuplicateTransient)
	uint8                                        Pad_18B2[0x8];                                     // Fixing Size After Last Property  > TateDumper <
...
public:
	...
	uint8                                        Pad_18B4[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	struct FTransform                            Transform;                                         // 0x10(0x60)(BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, OutParm)
	struct FKShapeElem                           Element;                                           // 0x70(0x30)(BlueprintVisible, ExportObject, Net, OutParm, DisableEditOnTemplate, Transient, Config, EditConst)
};
...
{
public:
	int32                                        NumVertices;                                       // 0x0(0x4)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, Net, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	int32                                        NumFaces;                                          // 0x4(0x4)(ExportObject, BlueprintReadOnly, Net, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
...
{
public:
	enum class EBrushToolSizeType                SizeType;                                          // 0x0(0x1)(ConstParm, BlueprintReadOnly, EditFixedSize, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_18BD[0x3];                                     // Fixing Size After Last Property  > TateDumper <
	float                                        AdaptiveSize;                                      // 0x4(0x4)(Edit, ConstParm, ExportObject, EditFixedSize, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	float                                        WorldRadius;                                       // 0x8(0x4)(BlueprintVisible, EditFixedSize, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_18BE[0x8];                                     // Fixing Size Of Struct > TateDumper <
};
