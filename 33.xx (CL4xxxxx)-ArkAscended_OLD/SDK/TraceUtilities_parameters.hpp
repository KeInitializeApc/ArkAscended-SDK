...
{
public:
	class FString                                ChannelName;                                       // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, Transient, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	...
	uint8                                        Pad_1F91[0x6];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(Edit, ConstParm, ExportObject, Net, Parm, OutParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
...
public:
	...
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(Edit, ConstParm, ExportObject, Net, Parm, OutParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
	bool                                         ReturnValue;                                       // 0x20(0x1)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
	uint8                                        Pad_1FA9[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	uint8                                        Pad_1FBC[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
