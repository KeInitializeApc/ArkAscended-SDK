...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                              InBindingIndex                                                   (BlueprintReadOnly, OutParm, DisableEditOnTemplate, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
// class UObject*                     InBindingObject                                                  (Edit, ConstParm, BlueprintVisible, OutParm, DisableEditOnTemplate, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
