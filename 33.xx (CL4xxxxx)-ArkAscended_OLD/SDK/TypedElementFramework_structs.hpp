...
{
public:
	uint8                                        Pad_22D6[0x8];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22D8[0x1];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22D9[0x1];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22DC[0xF];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22DD[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22DE[0x10];                                    // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22E1[0xF];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22E2[0xB];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22E4[0xF];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22E6[0x5F];                                    // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22E7[0x3];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	uint8                                        Pad_22EC[0x3];                                     // Fixing Size Of Struct > TateDumper <
};
