...
public:
	...
	struct FMovieSceneConstraintChannel          ActiveChannel;                                     // 0x30(0x100)(ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, ReturnParm, DisableEditOnTemplate, InstancedReference, SubobjectReference)
	class UTickableConstraint*                   ConstraintCopyToSpawn;                             // 0x130(0x8)(ConstParm, BlueprintReadOnly, EditFixedSize, ReturnParm, DisableEditOnTemplate, InstancedReference, SubobjectReference)
};
...
{
public:
	uint8                                        Pad_CA9[0x18];                                     // Fixing Size Of Struct > TateDumper <
};
