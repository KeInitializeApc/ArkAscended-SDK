...
{
public:
	uint8                                        Pad_10B[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_10C[0x18];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	TMap<class UClass*, struct FPlatformSettingsInstances> SettingsMap;                                       // 0x28(0x50)(ConstParm, BlueprintVisible, OutParm, ZeroConstructor, Transient, Config, GlobalConfig, InstancedReference, SubobjectReference)
	uint8                                        Pad_10D[0x8];                                      // Fixing Size Of Struct > TateDumper <
