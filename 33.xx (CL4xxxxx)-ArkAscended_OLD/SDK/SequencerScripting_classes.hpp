...
{
public:
	uint8                                        Pad_59A[0x18];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_5A6[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_5C2[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_5EC[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_637[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_64F[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_66F[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_75B[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_80E[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_83B[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_861[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_8BA[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_8BE[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_925[0x50];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_95D[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_987[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_9A3[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_9D3[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_9FC[0x20];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_A2E[0x30];                                     // Fixing Size Of Struct > TateDumper <
...
public:
	...
	void GetFolderColor(class UMovieSceneFolder** Folder, struct FColor* ReturnValue);
	void GetChildTracks(class UMovieSceneFolder** Folder, TArray<class UMovieSceneTrack*>* ReturnValue);
	void GetChildObjectBindings(class UMovieSceneFolder** Folder, TArray<struct FMovieSceneBindingProxy>* ReturnValue);
	void GetChildMasterTracks(class UMovieSceneFolder** Folder, TArray<class UMovieSceneTrack*>* ReturnValue);
	void GetChildFolders(class UMovieSceneFolder** Folder, TArray<class UMovieSceneFolder*>* ReturnValue);
