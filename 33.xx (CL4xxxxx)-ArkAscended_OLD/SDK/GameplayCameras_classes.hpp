...
{
public:
	float                                        OscillationDuration;                               // 0xF0(0x4)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        OscillationBlendInTime;                            // 0xF4(0x4)(BlueprintReadOnly, Net, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        OscillationBlendOutTime;                           // 0xF8(0x4)(Edit, ConstParm, Net, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	struct FROscillator                          RotOscillation;                                    // 0xFC(0x24)(Edit, ConstParm, ExportObject, BlueprintReadOnly, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	struct FVOscillator                          LocOscillation;                                    // 0x120(0x24)(Edit, ConstParm, BlueprintReadOnly, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	struct FFOscillator                          FOVOscillation;                                    // 0x144(0xC)(Edit, ConstParm, ExportObject, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        AnimPlayRate;                                      // 0x150(0x4)(Edit, BlueprintVisible, EditFixedSize, OutParm, ZeroConstructor, Transient, DisableEditOnInstance, InstancedReference, SubobjectReference)
	float                                        AnimScale;                                         // 0x154(0x4)(Edit, BlueprintVisible, EditFixedSize, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        AnimBlendInTime;                                   // 0x158(0x4)(BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        AnimBlendOutTime;                                  // 0x15C(0x4)(Edit, ConstParm, BlueprintReadOnly, Net, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        RandomAnimSegmentDuration;                         // 0x160(0x4)(Edit, BlueprintVisible, Net, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_185F[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	class UCameraAnim*                           Anim;                                              // 0x168(0x8)(Edit, ConstParm, ExportObject, OutParm, ZeroConstructor, ReturnParm, Config, InstancedReference, SubobjectReference)
	...
	uint8                                        bRandomAnimSegment : 1;                            // Mask: 0x1, PropSize: 0x10x178(0x1)(Edit, ConstParm, ExportObject, BlueprintReadOnly, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        BitPad_DD : 7;                                     // Fixing Bit-Field Size  > TateDumper <
	uint8                                        Pad_1862[0x3];                                     // Fixing Size After Last Property  > TateDumper <
	float                                        OscillatorTimeRemaining;                           // 0x17C(0x4)(ConstParm, BlueprintVisible, ExportObject, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	class UCameraAnimInst*                       AnimInst;                                          // 0x180(0x8)(ExportObject, Net, OutParm, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1864[0x78];                                    // Fixing Size After Last Property  > TateDumper <
	class USequenceCameraShakePattern*           SequenceShakePattern;                              // 0x200(0x8)(Edit, ConstParm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1867[0x28];                                    // Fixing Size Of Struct > TateDumper <
	...
	struct FMinimalViewInfo BlueprintUpdateCameraShake(float* Alpha, struct FMinimalViewInfo* ModifiedPOV);
};
...
{
public:
	TArray<struct FActiveCameraAnimationInfo>    ActiveAnimations;                                  // 0x48(0x10)(ConstParm, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint16                                       NextInstanceSerialNumber;                          // 0x58(0x2)(Edit, BlueprintVisible, BlueprintReadOnly, Net, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_18D1[0x6];                                     // Fixing Size Of Struct > TateDumper <
	...
	void IsCameraAnimationActive(struct FCameraAnimationHandle* Handle, bool* ReturnValue);
...
{
public:
	TArray<class UCameraShakePattern*>           ChildPatterns;                                     // 0x28(0x10)(Edit, ConstParm, ExportObject, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_18D7[0x10];                                    // Fixing Size Of Struct > TateDumper <
...
public:
	...
	void IsCameraAnimationActive(class APlayerController** PlayerController, struct FCameraAnimationHandle* Handle, bool* ReturnValue);
};
...
public:
	...
	float                                        BlendInTime;                                       // 0x2C(0x4)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, Net, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	float                                        BlendOutTime;                                      // 0x30(0x4)(BlueprintReadOnly, Net, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	uint8                                        Pad_1922[0x4];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	float                                        LocationAmplitudeMultiplier;                       // 0x38(0x4)(OutParm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        LocationFrequencyMultiplier;                       // 0x3C(0x4)(Edit, BlueprintReadOnly, Net, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	...
	float                                        RotationAmplitudeMultiplier;                       // 0x58(0x4)(ConstParm, Net, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        RotationFrequencyMultiplier;                       // 0x5C(0x4)(Edit, ConstParm, BlueprintReadOnly, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	...
	uint8                                        Pad_192A[0x38];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	struct FVector                               LocationOffset;                                    // 0x38(0x18)(ConstParm, BlueprintVisible, ExportObject, Parm, ReturnParm, DisableEditOnTemplate, Transient, InstancedReference, SubobjectReference)
	struct FRotator                              RotationOffset;                                    // 0x50(0x18)(BlueprintVisible, ExportObject, EditFixedSize, OutParm, ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
...
public:
	...
	float                                        RotationAmplitudeMultiplier;                       // 0x64(0x4)(ConstParm, Net, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	float                                        RotationFrequencyMultiplier;                       // 0x68(0x4)(Edit, ConstParm, BlueprintReadOnly, EditFixedSize, Parm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	...
	uint8                                        Pad_1934[0x3C];                                    // Fixing Size Of Struct > TateDumper <
