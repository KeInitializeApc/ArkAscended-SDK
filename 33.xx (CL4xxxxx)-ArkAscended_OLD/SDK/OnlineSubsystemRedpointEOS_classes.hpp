...
{
public:
	uint8                                        Pad_31C[0x220];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_31D[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_31E[0x78];                                     // Fixing Size After Last Property  > TateDumper <
	TArray<class UEOSNetConnection*>             PendingConnectionClose;                            // 0x8B8(0x10)(Edit, ConstParm, ExportObject, BlueprintReadOnly, EditFixedSize, OutParm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
...
{
public:
	FMulticastInlineDelegateProperty_            OnAddWidgetToViewport;                             // 0x30(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, OutParm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
	FMulticastInlineDelegateProperty_            OnRemoveWidgetFromViewport;                        // 0x40(0x10)(Edit, ConstParm, BlueprintVisible, Net, EditFixedSize, OutParm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
	uint8                                        Pad_31F[0x18];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_321[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_32E[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_335[0x10];                                     // Fixing Size Of Struct > TateDumper <

	static class UClass* StaticClass();
	static class UEOSUserInterface_SelectEOSAccount_Context* GetDefaultObj();

	void SelectCandidate(struct FEOSUserInterface_CandidateEOSAccount* SelectedCandidate);
};
...
{
public:
	uint8                                        Pad_338[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_33A[0x10];                                     // Fixing Size Of Struct > TateDumper <
...
public:
	...
	void SetupUserInterface(class UEOSUserInterface_SwitchToCrossPlatformAccount_Context** Context, class FString* EpicAccountName);
};
...
{
public:
	uint8                                        Pad_33F[0x60];                                     // Fixing Size Of Struct > TateDumper <
