...
{
public:
	uint8                                        Pad_1079[0x28];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_107F[0x20];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	FMulticastInlineDelegateProperty_            OnCompleted;                                       // 0x50(0x10)(ConstParm, ExportObject, Net, EditFixedSize, Parm, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1088[0x8];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	FMulticastInlineDelegateProperty_            OnExecution;                                       // 0x30(0x10)(Edit, BlueprintReadOnly, Net, EditFixedSize, Parm, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
...
public:
	...
	FMulticastInlineDelegateProperty_            OnExecution;                                       // 0x58(0x10)(Edit, BlueprintReadOnly, Net, EditFixedSize, Parm, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
	FMulticastInlineDelegateProperty_            OnCompleted;                                       // 0x68(0x10)(ConstParm, ExportObject, Net, EditFixedSize, Parm, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
...
public:
	...
	FMulticastInlineDelegateProperty_            OnCompleted;                                       // 0x60(0x10)(ConstParm, ExportObject, Net, EditFixedSize, Parm, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1114[0x18];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_1141[0x78];                                    // Fixing Size Of Struct > TateDumper <
