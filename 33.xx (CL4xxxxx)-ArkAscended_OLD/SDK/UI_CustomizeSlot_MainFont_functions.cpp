...
bool UUI_CustomizeSlot_MainFont_C::SetColor(struct FLinearColor* Color)
{
...
void UUI_CustomizeSlot_MainFont_C::GetColor(struct FLinearColor* Color, const struct FCFCoreThemeRowData& CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
