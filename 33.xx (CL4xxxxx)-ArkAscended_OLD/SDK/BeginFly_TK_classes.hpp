...
public:
	...
	struct FBlackboardKeySelector                OnFlyKey;                                          // 0xB0(0x28)(Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, OutParm, ReturnParm, EditConst, GlobalConfig, SubobjectReference)
