...
{
public:
	class UDataListEntryButton_CustomOverlay*    MyDataListButton;                                  // 0x3F8(0x8)(Edit, ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, Parm, Config, GlobalConfig, SubobjectReference)
