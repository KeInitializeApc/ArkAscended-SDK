...
public:
	...
	struct FBlackboardKeySelector                WithinAttackRangeKey;                              // 0xA8(0x28)(ConstParm, ExportObject, BlueprintReadOnly, Net, DisableEditOnInstance, EditConst, SubobjectReference)
