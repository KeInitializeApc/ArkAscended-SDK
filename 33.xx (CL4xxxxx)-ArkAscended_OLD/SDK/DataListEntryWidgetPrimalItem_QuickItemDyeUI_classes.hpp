...
{
public:
	class UDataListEntryButton_PrimalItem*       TheDataListButton;                                 // 0x3F8(0x8)(BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, SubobjectReference)
