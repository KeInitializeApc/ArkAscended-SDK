...
{
public:
	uint8                                        Pad_228A[0x950];                                   // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_22D1[0x8];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_22D3[0x8];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_22D4[0x10];                                    // Fixing Size Of Struct > TateDumper <
