...
{
public:
	class UImage*                                Bracket_SmallText;                                 // 0x7B8(0x8)(BlueprintReadOnly, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, SubobjectReference)
	...
	class UCustomButtonWidget*                   SetButton;                                         // 0x7D0(0x8)(Net, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, SubobjectReference)
