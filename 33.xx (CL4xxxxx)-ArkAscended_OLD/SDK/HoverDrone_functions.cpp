...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                              NewFOV                                                           (Edit, ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
...
// (Final, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct FVector                     VelocityImpulse                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
...
// (Final, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct FRotator                    RotationalVel                                                    (ConstParm, BlueprintVisible, ExportObject, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Config, EditConst, InstancedReference, SubobjectReference)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                              Val                                                              (Edit, ConstParm, BlueprintVisible, EditFixedSize, Config, EditConst, InstancedReference, SubobjectReference)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                              SpeedIndex                                                       (Edit, ZeroConstructor, Config, EditConst, InstancedReference, SubobjectReference)
