...
public:
	...
	uint8                                        Pad_27E3[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_ShouldForceFlee_ReturnValue;              // 0x31(0x1)(ExportObject, BlueprintReadOnly, Net, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
};
