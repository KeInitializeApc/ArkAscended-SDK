...
bool UUI_CustomizeSlot_Search_SideMenu_C::SetColor(struct FLinearColor* Color)
{
...
void UUI_CustomizeSlot_Search_SideMenu_C::GetColor(struct FLinearColor* Color, const struct FCFCoreThemeRowData& CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
