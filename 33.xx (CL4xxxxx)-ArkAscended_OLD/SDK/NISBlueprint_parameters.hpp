...
{
public:
	enum class EUNISMode                         NISMode;                                           // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Net, Parm, OutParm, Config, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        CustomScreenPercentage;                            // 0x0(0x4)(Edit, ExportObject, BlueprintReadOnly, Net, Parm, OutParm, Config, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	TArray<enum class EUNISMode>                 ReturnValue;                                       // 0x0(0x10)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
public:
	enum class EUNISMode                         NISMode;                                           // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Net, Parm, OutParm, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1401[0x3];                                     // Fixing Size After Last Property  > TateDumper <
...
{
public:
	enum class EUNISMode                         ReturnValue;                                       // 0x0(0x1)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
