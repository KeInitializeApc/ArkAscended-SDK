...
{
public:
	uint8                                        Pad_1E1D[0x8];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	int32                                        JitterLatencyFrames;                               // 0x7C0(0x4)(ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, Parm, Transient, Config, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_1E35[0xBC];                                    // Fixing Size Of Struct > TateDumper <
