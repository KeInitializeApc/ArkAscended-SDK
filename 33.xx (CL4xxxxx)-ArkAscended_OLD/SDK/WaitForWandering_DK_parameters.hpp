...
public:
	...
	uint8                                        Pad_117F[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_1182[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x31(0x1)(Edit, ConstParm, ExportObject, BlueprintReadOnly, Net, Parm, OutParm, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, SubobjectReference)
};
