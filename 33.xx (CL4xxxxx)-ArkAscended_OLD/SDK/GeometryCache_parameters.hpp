...
{
public:
	class UGeometryCacheComponent*               ReturnValue;                                       // 0x0(0x8)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
public:
	...
	bool                                         bInIsRunning;                                      // 0x4(0x1)(Edit, ConstParm, BlueprintVisible, ExportObject, EditFixedSize, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	bool                                         bInBackwards;                                      // 0x5(0x1)(ExportObject, EditFixedSize, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	bool                                         bInIsLooping;                                      // 0x6(0x1)(Edit, EditFixedSize, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_7A0[0x1];                                      // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	float                                        NewStartTimeOffset;                                // 0x0(0x4)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, Net, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        NewPlaybackSpeed;                                  // 0x0(0x4)(ConstParm, BlueprintVisible, ExportObject, Net, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	bool                                         bOverride;                                         // 0x0(0x1)(ConstParm, BlueprintReadOnly, EditFixedSize, ZeroConstructor, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        NewMotionVectorScale;                              // 0x0(0x4)(Edit, ConstParm, Net, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	bool                                         bNewLooping;                                       // 0x0(0x1)(BlueprintVisible, ExportObject, BlueprintReadOnly, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	class UGeometryCache*                        NewGeomCache;                                      // 0x0(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	...
	uint8                                        Pad_7D1[0x7];                                      // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	bool                                         bNewExtrapolating;                                 // 0x0(0x1)(Edit, ConstParm, ExportObject, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	struct FGeometryCacheMeshData                MeshData;                                          // 0x0(0xC8)(BlueprintVisible, Net, Parm, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	float                                        SampleTime;                                        // 0xC8(0x4)(ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
	uint8                                        Pad_854[0x4];                                      // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	struct FGeometryCacheMeshData                NewMeshData;                                       // 0x0(0xC8)(ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, Net, Parm, OutParm, ZeroConstructor, ReturnParm, EditConst, InstancedReference, SubobjectReference)
};
