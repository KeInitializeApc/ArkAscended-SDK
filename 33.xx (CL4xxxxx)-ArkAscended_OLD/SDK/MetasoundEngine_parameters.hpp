...
{
public:
	class UAudioComponent*                       OnComponent;                                       // 0x0(0x8)(ExportObject, EditFixedSize, OutParm, Transient, Config, EditConst, InstancedReference, SubobjectReference)
	class UMetasoundGeneratorHandle*             ReturnValue;                                       // 0x8(0x8)(ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
{
public:
	class UMetasoundParameterPack*               Pack;                                              // 0x0(0x8)(Edit, BlueprintVisible, EditFixedSize, OutParm, Transient, Config, EditConst, InstancedReference, SubobjectReference)
	...
	uint8                                        Pad_1E44[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	TArray<struct FMetaSoundAssetDirectory>      Directories;                                       // 0x0(0x10)(ExportObject, BlueprintReadOnly, Parm, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
};
