...
// struct FTerms                      K2Node_CustomEvent_terms                                         (Edit, ConstParm, BlueprintReadOnly, Parm, DisableEditOnTemplate, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
...
struct FCFCoreError UUI_PrivacyAndTerms_2_C::ExecuteUbergraph_UI_PrivacyAndTerms_2(int32* EntryPoint, const struct FTerms& K2Node_CustomEvent_terms, class FText* CallFunc_Conv_StringToText_ReturnValue)
{
	static class UFunction* Func = nullptr;
