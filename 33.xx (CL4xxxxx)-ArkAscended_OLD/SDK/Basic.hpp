...
public:
	...
	uint8                                        Pad_4C71[0x4];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
public:
	...
	uint8                                        Pad_4C72[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_4C73[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4C74[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4C75[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4C76[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
