...
// Parameters:
// class UAudioComponent*             OnComponent                                                      (ExportObject, EditFixedSize, OutParm, Transient, Config, EditConst, InstancedReference, SubobjectReference)
// class UMetasoundGeneratorHandle*   ReturnValue                                                      (ConstParm, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
...
// Parameters:
// class UMetasoundParameterPack*     Pack                                                             (Edit, BlueprintVisible, EditFixedSize, OutParm, Transient, Config, EditConst, InstancedReference, SubobjectReference)
...
// Parameters:
// TArray<struct FMetaSoundAssetDirectory>Directories                                                      (ExportObject, BlueprintReadOnly, Parm, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
