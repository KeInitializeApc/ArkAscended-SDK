...
// Parameters:
// struct FChaosPhysicsCollisionInfo  PhysicsCollision                                                 (Edit, ConstParm, BlueprintVisible, ExportObject, Net, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
