...
// (Final, Native, Public)
// Parameters:
// bool                               bWorldIn                                                         (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, Net, Parm, OutParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
...
// (Final, Native, Public)
// Parameters:
// bool                               bHoveringIn                                                      (ConstParm, BlueprintVisible, BlueprintReadOnly, Net, Parm, OutParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
...
void UGizmoBaseComponent::UpdateHoverState(bool* bHoveringIn)
{
	...
	if (bHoveringIn != nullptr)
		*bHoveringIn = Parms.bHoveringIn;
...
void IGizmoTransformSource::GetTransform(struct FTransform* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct FVector                     TangentXOut                                                      (Edit, ConstParm, BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
// struct FVector                     TangentYOut                                                      (ExportObject, BlueprintReadOnly, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)

struct FVector IGizmoAxisSource::GetTangentVectors()
{
	static class UFunction* Func = nullptr;
...
void IGizmoAxisSource::GetOrigin(struct FVector* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void IGizmoAxisSource::GetDirection(struct FVector* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Native, Public)
// Parameters:
// bool                               bInteracting                                                     (BlueprintVisible, ExportObject, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)

bool IGizmoClickTarget::UpdateInteractingState()
{
	static class UFunction* Func = nullptr;
...
// (Native, Public)
// Parameters:
// bool                               bHovering                                                        (ConstParm, BlueprintVisible, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)

bool IGizmoClickTarget::UpdateHoverState()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// bool                               bInteracting                                                     (BlueprintVisible, ExportObject, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
// uint32                             InPartIdentifier                                                 (Edit, ConstParm, BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)

uint32 IGizmoClickMultiTarget::UpdateInteractingState()
{
	static class UFunction* Func = nullptr;
...
uint32 IGizmoClickMultiTarget::UpdateHoverState()
{
	static class UFunction* Func = nullptr;
...
// (Native, Public)
// Parameters:
// bool                               bHittable                                                        (BlueprintVisible, ExportObject, BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
// uint32                             InPartIdentifier                                                 (Edit, ConstParm, BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)

uint32 IGizmoClickMultiTarget::UpdateHittableState()
{
	static class UFunction* Func = nullptr;
...
uint32 IGizmoRenderMultiTarget::UpdateVisibilityState()
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, HasOutParams, HasDefaults)
// Parameters:
// struct FVector2D                   NewValue                                                         (Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, Parm, OutParm, ReturnParm, DisableEditOnInstance, EditConst, SubobjectReference)
...
void IGizmoVec2ParameterSource::GetParameter(struct FVector2D* ReturnValue)
{
	static class UFunction* Func = nullptr;
