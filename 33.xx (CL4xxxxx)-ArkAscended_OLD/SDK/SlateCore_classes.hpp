...
{
public:
	class USlateWidgetStyleContainerBase*        CustomStyle;                                       // 0x28(0x8)(Edit, ExportObject, Parm, OutParm, Transient, Config, GlobalConfig, InstancedReference, SubobjectReference)
...
{
public:
	uint8                                        Pad_1C8[0x50];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_1CE[0x8];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	struct FGuid                                 CurrentThemeId;                                    // 0x28(0x10)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, Transient, Config, GlobalConfig, InstancedReference, SubobjectReference)
	struct FStyleColorList                       ActiveColors;                                      // 0x38(0x988)(BlueprintReadOnly, Parm, OutParm, Transient, Config, GlobalConfig, InstancedReference, SubobjectReference)
