...
class UClass* UCreatureTrackFilter_IsHerbivore_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsHerbivore_C");

	return Clss;
}


// CreatureTrackFilter_IsHerbivore_C CreatureTrackFilter_IsHerbivore.Default__CreatureTrackFilter_IsHerbivore_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsHerbivore_C* UCreatureTrackFilter_IsHerbivore_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsHerbivore_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsHerbivore_C*>(UCreatureTrackFilter_IsHerbivore_C::StaticClass()->DefaultObject);
...
bool UCreatureTrackFilter_IsHerbivore_C::ShouldActorBeTracked(class AActor** InvestigatedActor, int32 CustomTameSelectionType, int32 DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class AShooterCharacter** Requesting_player_Shooter_Character, bool* Debug_Enabled, bool Handled, bool* Ret_should_show, bool* CallFunc_ShouldActorBeTracked_Handled, bool* CallFunc_ShouldActorBeTracked_ReturnValue, class APrimalDinoCharacter** K2Node_DynamicCast_AsPrimal_Dino_Character, bool* K2Node_DynamicCast_bSuccess, bool Temp_bool_True_if_break_was_hit_Variable, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, TSoftClassPtr<class APrimalDinoCharacter> CallFunc_Array_Get_Item)
{
	...
	if (!Func)
		Func = Class->GetFunction("CreatureTrackFilter_IsHerbivore_C", "ShouldActorBeTracked");

	Params::UCreatureTrackFilter_IsHerbivore_C_ShouldActorBeTracked_Params Parms{};
