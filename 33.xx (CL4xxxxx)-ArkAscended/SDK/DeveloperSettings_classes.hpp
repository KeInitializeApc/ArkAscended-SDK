...
{
public:
	uint8                                        Pad_B5[0x10];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_BD[0x18];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	TMap<class UClass*, struct FPlatformSettingsInstances> SettingsMap;                                       // 0x28(0x50)(ExportObject, BlueprintReadOnly, EditFixedSize, GlobalConfig, InstancedReference, SubobjectReference)
	uint8                                        Pad_C1[0x8];                                       // Fixing Size Of Struct > TateDumper <
