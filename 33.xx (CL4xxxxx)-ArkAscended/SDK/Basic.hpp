...
public:
	...
	uint8                                        Pad_4CEC[0x4];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
public:
	...
	uint8                                        Pad_4CED[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_4CEE[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CEF[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF0[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF1[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF2[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF3[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF4[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF5[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4CF6[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
