...
public:
	...
	static constexpr uint32 FNameEntryStride = 2;
...
{
public:
	class FName                                  PackageName;                                       // 0x0(0x8)(BlueprintVisible, ExportObject, EditFixedSize, ZeroConstructor, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig)
	class FName                                  AssetName;                                         // 0x8(0x8)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, EditFixedSize, Parm, DisableEditOnTemplate, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
};
...
{
public:
	struct FTopLevelAssetPath                    AssetPath;                                         // 0x0(0x10)(Edit, ExportObject, OutParm, DisableEditOnTemplate, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
	class FString                                SubPathString;                                     // 0x10(0x10)(Edit, OutParm, DisableEditOnTemplate, DisableEditOnInstance, GlobalConfig, InstancedReference, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_4ED2[0x4];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
public:
	...
	uint8                                        Pad_4ED3[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_4ED4[0xC];                                     // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4ED5[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4ED6[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4ED7[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4ED8[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4ED9[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4EDA[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4EDB[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_4EDC[0x28];                                    // Fixing Size After Last (Predefined) Property  > TateDumper <
