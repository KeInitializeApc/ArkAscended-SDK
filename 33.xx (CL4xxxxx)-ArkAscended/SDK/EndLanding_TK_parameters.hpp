...
public:
	...
	uint8                                        Pad_37DB[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_37DC[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_37DD[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class ADino_AIController_BP_C*               K2Node_DynamicCast_AsDino_AIController_BP;         // 0x48(0x8)(Edit, BlueprintReadOnly, Net, Parm, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, SubobjectReference)
	...
	bool                                         CallFunc_CanLand_ReturnValue;                      // 0x51(0x1)(ConstParm, BlueprintVisible, BlueprintReadOnly, EditFixedSize, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, SubobjectReference)
	uint8                                        Pad_37DE[0x6];                                     // Fixing Size After Last Property  > TateDumper <
