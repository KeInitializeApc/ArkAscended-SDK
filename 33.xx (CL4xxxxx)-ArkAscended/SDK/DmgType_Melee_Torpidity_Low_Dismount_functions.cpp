...
class UClass* UDmgType_Melee_Torpidity_Low_Dismount_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DmgType_Melee_Torpidity_Low_Dismount_C");

	return Clss;
}


// DmgType_Melee_Torpidity_Low_Dismount_C DmgType_Melee_Torpidity_Low_Dismount.Default__DmgType_Melee_Torpidity_Low_Dismount_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDmgType_Melee_Torpidity_Low_Dismount_C* UDmgType_Melee_Torpidity_Low_Dismount_C::GetDefaultObj()
{
	static class UDmgType_Melee_Torpidity_Low_Dismount_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDmgType_Melee_Torpidity_Low_Dismount_C*>(UDmgType_Melee_Torpidity_Low_Dismount_C::StaticClass()->DefaultObject);
