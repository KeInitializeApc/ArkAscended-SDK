...
class UClass* IPrimalWidgetInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalWidgetInterface");

	return Clss;
}


// PrimalWidgetInterface Slate.Default__PrimalWidgetInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class IPrimalWidgetInterface* IPrimalWidgetInterface::GetDefaultObj()
{
	static class IPrimalWidgetInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IPrimalWidgetInterface*>(IPrimalWidgetInterface::StaticClass()->DefaultObject);
