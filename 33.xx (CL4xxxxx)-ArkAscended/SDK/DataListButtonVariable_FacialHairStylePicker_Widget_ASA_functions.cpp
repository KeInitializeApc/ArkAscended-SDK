...
class UClass* UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DataListButtonVariable_FacialHairStylePicker_Widget_ASA_C");

	return Clss;
}


// DataListButtonVariable_FacialHairStylePicker_Widget_ASA_C DataListButtonVariable_FacialHairStylePicker_Widget_ASA.Default__DataListButtonVariable_FacialHairStylePicker_Widget_ASA_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C* UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::GetDefaultObj()
{
	static class UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C*>(UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::StaticClass()->DefaultObject);
...
void UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::BPExecutedCommandForPrimalUI(class FName* CommandName, struct FBPNetExecParams* ExecParams)
{
	...
	Params::UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C_BPExecutedCommandForPrimalUI_Params Parms{};
...
void UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::SetParameterValue(class FString* Value, bool* bPreventCallParent)
{
	static class UFunction* Func = nullptr;
	...
	Params::UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C_SetParameterValue_Params Parms{};
...
bool UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C::ExecuteUbergraph_DataListButtonVariable_FacialHairStylePicker_Widget_ASA(int32* EntryPoint, class UPrimalGameData* CallFunc_BPGetGameData_ReturnValue, class UPrimalGameData* CallFunc_BPGetGameData_ReturnValue_1, class FName K2Node_Event_CommandName, const struct FBPNetExecParams& K2Node_Event_ExecParams, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue, const struct FSlateBrush& CallFunc_MakeBrushFromTexture_ReturnValue_1)
{
	...
	Params::UDataListButtonVariable_FacialHairStylePicker_Widget_ASA_C_ExecuteUbergraph_DataListButtonVariable_FacialHairStylePicker_Widget_ASA_Params Parms{};
