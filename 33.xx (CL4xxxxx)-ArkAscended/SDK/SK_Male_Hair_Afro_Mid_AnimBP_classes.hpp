...
{
public:
	uint8                                        Pad_5501[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         __CustomProperty_Swimming_34E7551E4D24DF41F25446BE7A01678A; // 0x9D2(0x1)(Edit, ConstParm, BlueprintVisible, ExportObject, EditFixedSize, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_5503[0x5];                                     // Fixing Size After Last Property  > TateDumper <
	...
	void ExecuteUbergraph_SK_Male_Hair_Afro_Mid_AnimBP(int32* EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character, bool* K2Node_DynamicCast_bSuccess);
};
