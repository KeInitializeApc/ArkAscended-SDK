...
{
public:
	uint8                                        Pad_5624[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_5625[0x5];                                     // Fixing Size After Last Property  > TateDumper <
	...
	double                                       Override_World_Gravity_Z;                          // 0x1098(0x8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	...
	bool                                         Swimming;                                          // 0x10A8(0x1)(ExportObject, EditFixedSize, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
	uint8                                        Pad_5626[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	double                                       UnderwaterGravity;                                 // 0x10B0(0x8)(Edit, ConstParm, Net, Parm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	double                                       Val;                                               // 0x10B8(0x8)(ConstParm, BlueprintVisible, ExportObject, Net, Parm, ReturnParm, DisableEditOnTemplate, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
	struct FVector                               Noise;                                             // 0x10C0(0x18)(ConstParm, BlueprintReadOnly, EditFixedSize, Parm, ReturnParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, InstancedReference, SubobjectReference)
	...
	struct FVector                               ExternalForce;                                     // 0x10E0(0x18)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, OutParm, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	...
	uint8                                        Pad_5627[0x4];                                     // Fixing Size After Last Property  > TateDumper <
