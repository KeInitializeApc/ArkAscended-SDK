...
{
public:
	uint8                                        Pad_2[0x68];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_3[0x10];                                       // Fixing Size After Last (Predefined) Property  > TateDumper <
	...
	uint8                                        Pad_4[0x54];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_5[0x30];                                       // Fixing Size After Last (Predefined) Property  > TateDumper <
	enum class EClassCastFlags                   CastFlags;                                         // (0xE0[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_6[0x30];                                       // Fixing Size After Last (Predefined) Property  > TateDumper <
	class UObject*                               DefaultObject;                                     // (0x118[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_7[0x100];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_8[0x10];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_9[0x18];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_A[0x28];                                       // Fixing Size Of Struct > TateDumper <
...
public:
	...
	uint8                                        Pad_B[0x20];                                       // Fixing Size After Last (Predefined) Property  > TateDumper <
...
{
public:
	uint8                                        Pad_C[0x10];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_D[0x80];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_E[0xB8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_F[0x10];                                       // Fixing Size After Last (Predefined) Property  > TateDumper <
	class TArray<class TPair<class FName, int64>> Names;                                             // (0x40[0x10]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_10[0x18];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_12[0x1C0];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_14[0xD0];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_16[0x1C0];                                     // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_17[0xA0];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_1B[0x40];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_1C[0x10];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_1E[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_20[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_22[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_23[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_26[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_27[0x28];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_28[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_29[0x20];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_2A[0x8];                                       // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_2C[0x8];                                       // Fixing Size Of Struct > TateDumper <
