...
{
public:
	uint8                                        Pad_57D8[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class FText RefreshOptions(int32 Temp_int_Loop_Counter_Variable, int32 Temp_int_Array_Index_Variable, class UPrimalGameData* CallFunc_BPGetGameData_ReturnValue, const struct FHairStyleDefinition& CallFunc_Array_Get_Item, bool* CallFunc_Greater_IntInt_ReturnValue, bool* CallFunc_Greater_IntInt_ReturnValue_1, bool* CallFunc_EqualEqual_IntInt_ReturnValue, class UWidget** CallFunc_GetChildAt_ReturnValue, class UOptionSelector_Widget_C** K2Node_DynamicCast_AsOption_Selector_Widget, bool* K2Node_DynamicCast_bSuccess);
	...
	bool ExecuteUbergraph_FacialHairStyle_Selector_ASA(int32* EntryPoint, class FName K2Node_Event_CommandName, const struct FBPNetExecParams& K2Node_Event_ExecParams, bool CallFunc_Conv_IntToBool_ReturnValue);
};
