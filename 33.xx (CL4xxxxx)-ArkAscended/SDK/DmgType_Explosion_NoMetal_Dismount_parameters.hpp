...
public:
	...
	uint8                                        Pad_53E5[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_53E6[0x3];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_53E7[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_53E8[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	struct FHitResult                            CallFunc_K2_SetActorLocation_SweepHitResult;       // 0x90(0xF0)(Edit, BlueprintVisible, BlueprintReadOnly, EditFixedSize, EditConst, SubobjectReference)
	bool                                         CallFunc_K2_SetActorLocation_ReturnValue;          // 0x180(0x1)(EditFixedSize, EditConst, SubobjectReference)
	uint8                                        Pad_53E9[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	double                                       CallFunc_Greater_DoubleDouble_A_ImplicitCast;      // 0x188(0x8)(BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Config, SubobjectReference)
};
