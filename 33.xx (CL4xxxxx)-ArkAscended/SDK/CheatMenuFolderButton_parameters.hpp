...
{
public:
	class FText                                  FolderName;                                        // 0x0(0x18)(ConstParm, ExportObject, OutParm, Transient, InstancedReference, SubobjectReference)
	int32                                        ScreenNumber;                                      // 0x18(0x4)(Edit, BlueprintReadOnly, EditFixedSize, ReturnParm, Transient, EditConst, SubobjectReference)
	uint8                                        Pad_317D[0x4];                                     // Fixing Size After Last Property  > TateDumper <
