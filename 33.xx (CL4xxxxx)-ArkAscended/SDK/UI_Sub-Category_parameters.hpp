...
public:
	...
	class UAsyncTaskDownloadImage*               CallFunc_DownloadImage_ReturnValue;                // 0x18(0x8)(Edit, Net, EditFixedSize, OutParm, Config, EditConst, GlobalConfig, SubobjectReference)
	...
	uint8                                        Pad_5C7[0x3];                                      // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_5C8[0x4];                                      // Fixing Size After Last Property  > TateDumper <
	class UTexture2DDynamic*                     K2Node_CustomEvent_Texture;                        // 0x40(0x8)(ConstParm, ExportObject, Net, Parm, OutParm, Config, EditConst, GlobalConfig, SubobjectReference)
	...
	struct FButtonStyle                          K2Node_CustomEvent_InStyle;                        // 0x50(0x3F0)(BlueprintVisible, ExportObject, BlueprintReadOnly, Parm, OutParm, Config, EditConst, GlobalConfig, SubobjectReference)
};
