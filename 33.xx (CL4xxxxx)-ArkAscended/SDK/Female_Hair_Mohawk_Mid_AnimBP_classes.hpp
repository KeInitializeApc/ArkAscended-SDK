...
{
public:
	uint8                                        Pad_50C9[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         __CustomProperty_Swimming_FEE367B5483EAD895AD27480043BF16B; // 0x9D2(0x1)(BlueprintVisible, ExportObject, EditFixedSize, Parm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
	uint8                                        Pad_50CA[0x5];                                     // Fixing Size After Last Property  > TateDumper <
	...
	void ExecuteUbergraph_Female_Hair_Mohawk_Mid_AnimBP(int32* EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character, bool* K2Node_DynamicCast_bSuccess);
};
