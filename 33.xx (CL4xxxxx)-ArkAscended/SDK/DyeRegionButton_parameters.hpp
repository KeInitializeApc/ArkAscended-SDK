...
public:
	...
	bool                                         CallFunc_GetIsEnabled_ReturnValue;                 // 0x4(0x1)(BlueprintReadOnly, Net, EditFixedSize, Parm, OutParm, ZeroConstructor, ReturnParm, Transient, Config, SubobjectReference)
