...
public:
	...
	bool                                         CallFunc_GetIsEnabled_ReturnValue;                 // 0x4(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, Net, Parm, ZeroConstructor, DisableEditOnTemplate, EditConst, SubobjectReference)
