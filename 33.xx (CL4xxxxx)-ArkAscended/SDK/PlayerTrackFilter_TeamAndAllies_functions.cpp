...
class UClass* UPlayerTrackFilter_TeamAndAllies_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerTrackFilter_TeamAndAllies_C");

	return Clss;
}


// PlayerTrackFilter_TeamAndAllies_C PlayerTrackFilter_TeamAndAllies.Default__PlayerTrackFilter_TeamAndAllies_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerTrackFilter_TeamAndAllies_C* UPlayerTrackFilter_TeamAndAllies_C::GetDefaultObj()
{
	static class UPlayerTrackFilter_TeamAndAllies_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerTrackFilter_TeamAndAllies_C*>(UPlayerTrackFilter_TeamAndAllies_C::StaticClass()->DefaultObject);
