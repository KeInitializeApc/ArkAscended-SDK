...
class UClass* UCreatureTrackFilter_IsCarnivore_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsCarnivore_C");

	return Clss;
}


// CreatureTrackFilter_IsCarnivore_C CreatureTrackFilter_IsCarnivore.Default__CreatureTrackFilter_IsCarnivore_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsCarnivore_C* UCreatureTrackFilter_IsCarnivore_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsCarnivore_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsCarnivore_C*>(UCreatureTrackFilter_IsCarnivore_C::StaticClass()->DefaultObject);
