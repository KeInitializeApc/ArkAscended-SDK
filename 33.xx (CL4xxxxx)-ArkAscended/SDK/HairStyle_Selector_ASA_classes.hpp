...
{
public:
	uint8                                        Pad_57DD[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool ExecuteUbergraph_HairStyle_Selector_ASA(int32* EntryPoint, class FName K2Node_Event_CommandName, const struct FBPNetExecParams& K2Node_Event_ExecParams, bool CallFunc_Conv_IntToBool_ReturnValue);
};
