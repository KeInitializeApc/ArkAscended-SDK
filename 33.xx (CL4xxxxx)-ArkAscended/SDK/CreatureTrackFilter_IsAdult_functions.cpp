...
class UClass* UCreatureTrackFilter_IsAdult_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsAdult_C");

	return Clss;
}


// CreatureTrackFilter_IsAdult_C CreatureTrackFilter_IsAdult.Default__CreatureTrackFilter_IsAdult_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsAdult_C* UCreatureTrackFilter_IsAdult_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsAdult_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsAdult_C*>(UCreatureTrackFilter_IsAdult_C::StaticClass()->DefaultObject);
...
bool UCreatureTrackFilter_IsAdult_C::ShouldActorBeTracked(class AActor** InvestigatedActor, int32 CustomTameSelectionType, int32 DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class AShooterCharacter** Requesting_player_Shooter_Character, bool* Debug_Enabled, bool Handled, bool* Ret_should_show, bool* CallFunc_ShouldActorBeTracked_Handled, bool* CallFunc_ShouldActorBeTracked_ReturnValue, class APrimalDinoCharacter** K2Node_DynamicCast_AsPrimal_Dino_Character, bool* K2Node_DynamicCast_bSuccess)
{
	...
	Params::UCreatureTrackFilter_IsAdult_C_ShouldActorBeTracked_Params Parms{};
