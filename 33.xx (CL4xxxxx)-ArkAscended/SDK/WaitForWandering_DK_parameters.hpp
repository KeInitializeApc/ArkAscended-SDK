...
public:
	...
	uint8                                        Pad_1D75[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_1D77[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x31(0x1)(ConstParm, ExportObject, EditFixedSize, OutParm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
};
