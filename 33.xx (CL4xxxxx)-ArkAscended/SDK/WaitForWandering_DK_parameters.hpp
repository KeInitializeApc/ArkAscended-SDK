...
public:
	...
	uint8                                        Pad_2327[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_2329[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x31(0x1)(Edit, BlueprintVisible, EditFixedSize, Parm, OutParm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, SubobjectReference)
};
