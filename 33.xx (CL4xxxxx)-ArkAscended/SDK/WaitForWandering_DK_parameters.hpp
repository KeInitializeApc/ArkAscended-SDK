...
public:
	...
	uint8                                        Pad_3603[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_3604[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x31(0x1)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, EditFixedSize, OutParm, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, SubobjectReference)
};
