...
public:
	...
	uint8                                        Pad_21E5[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_21E6[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_21E8[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	double                                       CallFunc_NoiseGen_DeltaTime_ImplicitCast;          // 0x68(0x8)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
...
public:
	...
	uint8                                        Pad_220E[0x3];                                     // Fixing Size After Last Property  > TateDumper <
	class FName                                  CallFunc_MakeLiteralName_ReturnValue;              // 0x24(0x8)(Edit, EditFixedSize, Parm, OutParm, ZeroConstructor, ReturnParm, Config, SubobjectReference)
	struct FLinearColor                          CallFunc_GetVectorParameterValue_ReturnValue;      // 0x2C(0x10)(ConstParm, ExportObject, Net, Parm, OutParm, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	class FName                                  CallFunc_MakeLiteralName_ReturnValue_1;            // 0x3C(0x8)(Edit, EditFixedSize, Parm, OutParm, ZeroConstructor, ReturnParm, Config, SubobjectReference, Interp)
	uint8                                        Pad_220F[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	struct FVector                               CallFunc_MakeVector_ReturnValue;                   // 0x48(0x18)(BlueprintVisible, Net, DisableEditOnInstance, SubobjectReference)
	float                                        CallFunc_GetScalarParameterValue_ReturnValue;      // 0x60(0x4)(Edit, ConstParm, BlueprintReadOnly, Parm, OutParm, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	uint8                                        Pad_2210[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	struct FVector                               CallFunc_Normal_ReturnValue;                       // 0x68(0x18)(ConstParm, ExportObject, Net, Parm, DisableEditOnTemplate, Transient, Config, SubobjectReference)
