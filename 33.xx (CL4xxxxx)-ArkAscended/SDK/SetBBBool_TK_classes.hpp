...
public:
	...
	struct FBlackboardKeySelector                BlackboardKey;                                     // 0xB0(0x28)(Edit, BlueprintReadOnly, Net, EditFixedSize, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
