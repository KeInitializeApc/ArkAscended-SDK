...
class UClass* UPrimalItem_Spawner_Mek_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalItem_Spawner_Mek_C");

	return Clss;
}


// PrimalItem_Spawner_Mek_C PrimalItem_Spawner_Mek.Default__PrimalItem_Spawner_Mek_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrimalItem_Spawner_Mek_C* UPrimalItem_Spawner_Mek_C::GetDefaultObj()
{
	static class UPrimalItem_Spawner_Mek_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrimalItem_Spawner_Mek_C*>(UPrimalItem_Spawner_Mek_C::StaticClass()->DefaultObject);
...
bool UPrimalItem_Spawner_Mek_C::BPCanUse(bool CanUse_, class AShooterCharacter* CallFunc_GetOwnerPlayer_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, class AShooterPlayerController** K2Node_DynamicCast_AsShooter_Player_Controller, bool* K2Node_DynamicCast_bSuccess)
{
	...
	Params::UPrimalItem_Spawner_Mek_C_BPCanUse_Params Parms{};
...
class FString UPrimalItem_Spawner_Mek_C::GetStatDisplayString(int32* Value, const class FString& CallFunc_GetStatDisplayString_StatDisplay, const class FString& CallFunc_GetStatDisplayString_ValueDisplay, bool* CallFunc_GetStatDisplayString_ShowInTooltip)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPrimalItem_Spawner_Mek_C_GetStatDisplayString_Params Parms{};
