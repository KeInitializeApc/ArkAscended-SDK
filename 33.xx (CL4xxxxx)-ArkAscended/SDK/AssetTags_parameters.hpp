...
public:
	...
	TArray<class FName>                          ReturnValue;                                       // 0x20(0x10)(Edit, ConstParm, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
{
public:
	class UObject*                               AssetPtr;                                          // 0x0(0x8)(ConstParm, BlueprintVisible, ExportObject, Parm, OutParm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
...
public:
	...
	TArray<class FName>                          ReturnValue;                                       // 0x68(0x10)(Edit, ConstParm, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
{
public:
	class FName                                  AssetPathName;                                     // 0x0(0x8)(ConstParm, BlueprintVisible, Parm, OutParm, ReturnParm, Config, EditConst, InstancedReference, SubobjectReference)
	TArray<class FName>                          ReturnValue;                                       // 0x8(0x10)(Edit, ConstParm, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_25D1[0x3];                                     // Fixing Size Of Struct > TateDumper <
};
