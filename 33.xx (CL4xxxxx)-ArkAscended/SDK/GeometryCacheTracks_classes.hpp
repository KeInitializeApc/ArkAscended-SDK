...
{
public:
	struct FMovieSceneGeometryCacheParams        Params;                                            // 0xF0(0x48)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, ReturnParm, Config, EditConst, SubobjectReference)
