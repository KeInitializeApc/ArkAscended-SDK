...
{
public:
	class FString                                ChannelName;                                       // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, Parm, ReturnParm, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	...
	uint8                                        Pad_2775[0x6];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(BlueprintReadOnly, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
	...
	uint8                                        Pad_277A[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(BlueprintReadOnly, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Edit, ConstParm, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, EditConst, SubobjectReference)
	uint8                                        Pad_277B[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
...
public:
	...
	uint8                                        Pad_2786[0x7];                                     // Fixing Size Of Struct > TateDumper <
};
