...
public:
	...
	uint8                                        Pad_28E2[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_28E4[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_28E9[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	class AActor*                                CallFunc_GetTamedLandTarget_ReturnValue;           // 0x38(0x8)(Net, EditFixedSize, Parm, OutParm, ZeroConstructor, GlobalConfig, SubobjectReference)
	bool                                         CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x40(0x1)(Edit, ConstParm, ExportObject, Net, EditFixedSize, Parm, ZeroConstructor, DisableEditOnTemplate, Transient, SubobjectReference)
