...
public:
	...
	class UWidgetAnimation*                      OnHovered;                                         // 0x338(0x8)(Edit, BlueprintReadOnly, Net, OutParm, ZeroConstructor, Config, EditConst, InstancedReference, SubobjectReference)
	class UWidgetAnimation*                      OnSelected;                                        // 0x340(0x8)(BlueprintVisible, Net, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	class UButton*                               Button_DropDown;                                   // 0x348(0x8)(ConstParm, BlueprintVisible, EditFixedSize, ZeroConstructor, Config, InstancedReference, SubobjectReference)
	class UImage*                                IMG_DropDown;                                      // 0x350(0x8)(ConstParm, Net, Parm, ZeroConstructor, Config, InstancedReference, SubobjectReference)
	class UTextBlock*                            TEXT_DropDown;                                     // 0x358(0x8)(BlueprintVisible, Net, OutParm, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
	...
	FMulticastInlineDelegateProperty_            Dispatcher_OnReleased;                             // 0x390(0x10)(ConstParm, BlueprintVisible, Net, EditFixedSize, ZeroConstructor, Config, InstancedReference, SubobjectReference)
	bool                                         ExitAfterClick;                                    // 0x3A0(0x1)(ConstParm, ExportObject, BlueprintReadOnly, Parm, ZeroConstructor, Config, InstancedReference, SubobjectReference)
