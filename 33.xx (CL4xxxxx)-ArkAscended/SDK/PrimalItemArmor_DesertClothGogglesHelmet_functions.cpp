...
class UClass* UPrimalItemArmor_DesertClothGogglesHelmet_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalItemArmor_DesertClothGogglesHelmet_C");

	return Clss;
}


// PrimalItemArmor_DesertClothGogglesHelmet_C PrimalItemArmor_DesertClothGogglesHelmet.Default__PrimalItemArmor_DesertClothGogglesHelmet_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrimalItemArmor_DesertClothGogglesHelmet_C* UPrimalItemArmor_DesertClothGogglesHelmet_C::GetDefaultObj()
{
	static class UPrimalItemArmor_DesertClothGogglesHelmet_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrimalItemArmor_DesertClothGogglesHelmet_C*>(UPrimalItemArmor_DesertClothGogglesHelmet_C::StaticClass()->DefaultObject);
...
bool UPrimalItemArmor_DesertClothGogglesHelmet_C::BlueprintEquipped()
{
	...
	Params::UPrimalItemArmor_DesertClothGogglesHelmet_C_BlueprintEquipped_Params Parms{};
...
class APrimalBuff* UPrimalItemArmor_DesertClothGogglesHelmet_C::ExecuteUbergraph_PrimalItemArmor_DesertClothGogglesHelmet(int32* EntryPoint, class AActor* CallFunc_GetOwner_ReturnValue, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character, bool* K2Node_DynamicCast_bSuccess, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character_1, bool* K2Node_DynamicCast_bSuccess_1)
{
	...
	Params::UPrimalItemArmor_DesertClothGogglesHelmet_C_ExecuteUbergraph_PrimalItemArmor_DesertClothGogglesHelmet_Params Parms{};
