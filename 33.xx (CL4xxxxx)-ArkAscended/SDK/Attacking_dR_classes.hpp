...
public:
	...
	struct FBlackboardKeySelector                WithinAttackRangeKey;                              // 0xA8(0x28)(Edit, ConstParm, BlueprintVisible, Net, EditFixedSize, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, EditConst, SubobjectReference)
	...
	bool ExecuteUbergraph_Attacking_DR(int32 EntryPoint, class AActor* K2Node_Event_OwnerActor_2, class AActor* K2Node_Event_OwnerActor_1, enum class EBTNodeResult* K2Node_Event_NodeResult, class AActor* K2Node_Event_OwnerActor);
};
