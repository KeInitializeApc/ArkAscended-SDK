...
public:
	...
	uint8                                        Pad_2E9D[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_2E9E[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class AActor*                                CallFunc_GetTarget_ReturnValue;                    // 0x28(0x8)(BlueprintVisible, BlueprintReadOnly, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
	...
	uint8                                        Pad_2EA1[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	class APrimalDinoCharacter*                  CallFunc_GetFirstValidWildFollowingParentRef_ReturnValue; // 0x40(0x8)(ConstParm, BlueprintVisible, BlueprintReadOnly, EditFixedSize, Parm, Config, GlobalConfig, SubobjectReference)
