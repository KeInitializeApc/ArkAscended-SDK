...
{
public:
	uint8                                        Pad_D61[0x950];                                    // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_D8B[0x8];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_D8C[0x8];                                      // Fixing Size Of Struct > TateDumper <
...
{
public:
	uint8                                        Pad_D8F[0x10];                                     // Fixing Size Of Struct > TateDumper <
