...
class UClass* UVehicleTrackFilter_Any_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VehicleTrackFilter_Any_C");

	return Clss;
}


// VehicleTrackFilter_Any_C VehicleTrackFilter_Any.Default__VehicleTrackFilter_Any_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UVehicleTrackFilter_Any_C* UVehicleTrackFilter_Any_C::GetDefaultObj()
{
	static class UVehicleTrackFilter_Any_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVehicleTrackFilter_Any_C*>(UVehicleTrackFilter_Any_C::StaticClass()->DefaultObject);
...
bool UVehicleTrackFilter_Any_C::ShouldActorBeTracked(class AActor** InvestigatedActor, int32 CustomTameSelectionType, int32 DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class AShooterCharacter** Requesting_player_Shooter_Character, bool* Debug_Enabled, bool Handled, bool* Ret_should_show, bool* CallFunc_ShouldActorBeTracked_Handled, bool* CallFunc_ShouldActorBeTracked_ReturnValue)
{
	...
	Params::UVehicleTrackFilter_Any_C_ShouldActorBeTracked_Params Parms{};
