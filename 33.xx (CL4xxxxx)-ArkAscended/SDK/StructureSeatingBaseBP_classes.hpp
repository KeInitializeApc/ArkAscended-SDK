...
{
public:
	class UChildActorComponent*                  TargetingEmitter;                                  // 0x1608(0x8)(ExportObject, ReturnParm, DisableEditOnTemplate, EditConst, SubobjectReference)
	class USphereComponent*                      StasisComponent;                                   // 0x1610(0x8)(Edit, EditFixedSize, OutParm, ReturnParm, DisableEditOnInstance)
	bool                                         bAllowFishing;                                     // 0x1618(0x1)(ReturnParm, DisableEditOnTemplate, EditConst, SubobjectReference)
