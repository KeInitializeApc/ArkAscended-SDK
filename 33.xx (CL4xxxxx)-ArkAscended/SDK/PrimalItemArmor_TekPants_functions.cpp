...
class UClass* UPrimalItemArmor_TekPants_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalItemArmor_TekPants_C");

	return Clss;
}


// PrimalItemArmor_TekPants_C PrimalItemArmor_TekPants.Default__PrimalItemArmor_TekPants_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrimalItemArmor_TekPants_C* UPrimalItemArmor_TekPants_C::GetDefaultObj()
{
	static class UPrimalItemArmor_TekPants_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrimalItemArmor_TekPants_C*>(UPrimalItemArmor_TekPants_C::StaticClass()->DefaultObject);
...
bool UPrimalItemArmor_TekPants_C::OverrideCrouchingSound(bool Temp_bool_Variable, int32* Temp_int_Variable, int32* Temp_int_Variable_1, class USoundBase* K2Node_Select_Default, class USoundBase* K2Node_Select_Default_1, class USoundBase* K2Node_Select_Default_2)
{
	...
	Params::UPrimalItemArmor_TekPants_C_OverrideCrouchingSound_Params Parms{};
