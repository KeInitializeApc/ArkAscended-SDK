...
{
public:
	class UResonanceAudioReverbPluginPreset*     InPreset;                                          // 0x0(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, InstancedReference, SubobjectReference)
};
...
{
public:
	class UResonanceAudioReverbPluginPreset*     ReturnValue;                                       // 0x0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, SubobjectReference)
};
...
{
public:
	struct FQuat                                 InRotation;                                        // 0x0(0x20)(ConstParm, ExportObject, BlueprintReadOnly, EditFixedSize, Parm, OutParm, ReturnParm, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
};
...
{
public:
	TArray<enum class ERaMaterialName>           InMaterials;                                       // 0x0(0x10)(ConstParm, ExportObject, BlueprintReadOnly, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	struct FVector                               InDimensions;                                      // 0x0(0x18)(Edit, ConstParm, BlueprintReadOnly, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InReverbTimeModifier;                              // 0x0(0x4)(ExportObject, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InReverbGain;                                      // 0x0(0x4)(Edit, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InReverbBrightness;                                // 0x0(0x4)(Edit, ConstParm, BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InReflectionScalar;                                // 0x0(0x4)(Edit, BlueprintVisible, ExportObject, Net, EditFixedSize, Parm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	bool                                         bInEnableRoomEffects;                              // 0x0(0x1)(ConstParm, Net, EditFixedSize, Parm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InSpread;                                          // 0x0(0x4)(ConstParm, ExportObject, EditFixedSize, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	float                                        InPattern;                                         // 0x0(0x4)(Edit, BlueprintVisible, Net, Parm, Config, InstancedReference, SubobjectReference)
	float                                        InSharpness;                                       // 0x4(0x4)(Edit, ConstParm, EditFixedSize, OutParm, ZeroConstructor, Transient, Config, InstancedReference, SubobjectReference)
};
