...
{
public:
	bool                                         bExplicitCanvasChildZOrder;                        // 0x28(0x1)(ConstParm, BlueprintVisible, ExportObject, ZeroConstructor, Transient, Config, GlobalConfig, InstancedReference, SubobjectReference)
	uint8                                        Pad_1675[0x7];                                     // Fixing Size Of Struct > TateDumper <
