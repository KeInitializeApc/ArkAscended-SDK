...
{
public:
	uint8                                        Pad_5618[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         __CustomProperty_Swimming_0C38EFD94C0A68B23FD0FD80E596A6F0; // 0x9D2(0x1)(Edit, ExportObject, BlueprintReadOnly, ReturnParm, Transient, Config, DisableEditOnInstance, InstancedReference, SubobjectReference)
	uint8                                        Pad_5619[0x5];                                     // Fixing Size After Last Property  > TateDumper <
	...
	void ExecuteUbergraph_SK_Male_Hair_Afro_Long_AnimBP(int32* EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character, bool* K2Node_DynamicCast_bSuccess);
};
