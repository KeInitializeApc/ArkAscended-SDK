...
public:
	...
	uint8                                        Pad_40F2[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_40F3[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_40F4[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x40(0x1)(ConstParm, ExportObject, EditFixedSize, OutParm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
};
