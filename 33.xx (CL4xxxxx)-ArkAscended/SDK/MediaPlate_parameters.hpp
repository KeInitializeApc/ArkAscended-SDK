...
{
public:
	bool                                         bInPlayOnlyWhenVisible;                            // 0x0(0x1)(BlueprintVisible, ExportObject, ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	struct FVector2D                             InMeshRange;                                       // 0x0(0x10)(Edit, BlueprintVisible, ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	bool                                         bInLoop;                                           // 0x0(0x1)(ReturnParm, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	bool                                         bInIsAspectRatioAuto;                              // 0x0(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, Net, EditFixedSize, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_61E[0x7];                                      // Fixing Size Of Struct > TateDumper <
};
...
{
public:
	class FString                                DeviceUrl;                                         // 0x0(0x10)(Edit, ConstParm, BlueprintVisible, ExportObject, Net, EditFixedSize, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Config, InstancedReference, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_644[0x4];                                      // Fixing Size After Last Property  > TateDumper <
	class UMediaTexture*                         ReturnValue;                                       // 0x8(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, SubobjectReference)
};
