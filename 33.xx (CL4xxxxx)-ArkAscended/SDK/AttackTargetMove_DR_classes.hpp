...
public:
	...
	bool ExecuteUbergraph_AttackTargetMove_DR(int32 EntryPoint, class AActor* K2Node_Event_OwnerActor, class APawn* CallFunc_K2_GetPawn_ReturnValue, class APrimalDinoCharacter* K2Node_DynamicCast_AsPrimal_Dino_Character, bool* CallFunc_IsCurrentAttackStopsMovement_ReturnValue);
};
