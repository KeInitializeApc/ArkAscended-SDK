...
{
public:
	bool                                         Ready;                                             // 0x0(0x1)(ConstParm, BlueprintVisible, EditFixedSize, Parm, DisableEditOnTemplate, Transient, Config, InstancedReference, SubobjectReference)
};
...
{
public:
	class FString                                Tag;                                               // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, Net, Parm, OutParm, ZeroConstructor, ReturnParm, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
...
{
public:
	enum class EPlatform                         Platform;                                          // 0x0(0x1)(ConstParm, BlueprintVisible, EditFixedSize, Parm, OutParm, ReturnParm, EditConst, DuplicateTransient)
};
...
public:
	...
	uint8                                        Pad_1120[0x3];                                     // Fixing Size After Last Property  > TateDumper <
