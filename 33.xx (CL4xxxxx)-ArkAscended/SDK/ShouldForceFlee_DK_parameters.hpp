...
public:
	...
	uint8                                        Pad_27F0[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_27F2[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	bool                                         CallFunc_ShouldForceFlee_ReturnValue;              // 0x31(0x1)(Edit, ExportObject, Net, EditFixedSize, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, GlobalConfig, InstancedReference, SubobjectReference)
};
