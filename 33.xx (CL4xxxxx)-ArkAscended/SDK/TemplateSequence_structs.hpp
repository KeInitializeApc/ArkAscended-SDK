...
{
public:
	struct FGuid                                 ObjectBinding;                                     // 0x0(0x10)(Edit, BlueprintVisible, ExportObject, OutParm, ZeroConstructor, ReturnParm, Transient, Config, InstancedReference, SubobjectReference)
	...
	enum class ETemplateSectionPropertyScaleType PropertyScaleType;                                 // 0x24(0x4)(Edit, ExportObject, BlueprintReadOnly, Net, EditFixedSize, Parm, ZeroConstructor, ReturnParm, Transient, Config, InstancedReference, SubobjectReference)
	struct FMovieSceneFloatChannel               FloatChannel;                                      // 0x28(0x110)(ConstParm, BlueprintVisible, Net, EditFixedSize, OutParm, ZeroConstructor, Transient, Config, DisableEditOnInstance, EditConst, GlobalConfig, SubobjectReference)
};
...
public:
	...
	uint8                                        Pad_1B4B[0x3];                                     // Fixing Size Of Struct > TateDumper <
};
