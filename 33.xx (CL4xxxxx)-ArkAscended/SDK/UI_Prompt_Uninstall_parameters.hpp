...
public:
	...
	bool                                         CallFunc_IsValid_ReturnValue_1;                    // 0x5(0x1)(Edit, BlueprintVisible, Net, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, Config, SubobjectReference, Interp)
	uint8                                        Pad_238B[0x2];                                     // Fixing Size After Last Property  > TateDumper <
	...
	struct FGeometry                             K2Node_Event_MyGeometry;                           // 0x18(0x38)(Edit, ExportObject, Net, EditFixedSize, OutParm, Transient, DisableEditOnInstance, SubobjectReference)
	float                                        K2Node_Event_InDeltaTime;                          // 0x50(0x4)(BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, OutParm, Transient, DisableEditOnInstance, SubobjectReference)
};
