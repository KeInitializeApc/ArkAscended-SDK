...
class UClass* UCreatureTrackFilter_IsFlyer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsFlyer_C");

	return Clss;
}


// CreatureTrackFilter_IsFlyer_C CreatureTrackFilter_IsFlyer.Default__CreatureTrackFilter_IsFlyer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsFlyer_C* UCreatureTrackFilter_IsFlyer_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsFlyer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsFlyer_C*>(UCreatureTrackFilter_IsFlyer_C::StaticClass()->DefaultObject);
