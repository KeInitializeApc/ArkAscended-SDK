...
{
public:
	class UDataListEntryButton_CustomOverlay*    MyDataListButton;                                  // 0x3F8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, EditFixedSize, OutParm, Config, GlobalConfig, SubobjectReference)
