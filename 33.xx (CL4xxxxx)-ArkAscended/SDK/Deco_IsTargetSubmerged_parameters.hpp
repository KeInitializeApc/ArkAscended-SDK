...
public:
	...
	class AActor*                                CallFunc_GetBlackboardValueAsActor_ReturnValue;    // 0x8(0x8)(ConstParm, ExportObject, EditFixedSize, Parm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, Config, EditConst, GlobalConfig, SubobjectReference)
	...
	bool                                         CallFunc_IsSubmerged_ReturnValue;                  // 0x19(0x1)(Edit, Parm, DisableEditOnTemplate, EditConst, SubobjectReference)
};
