...
class UClass* UCreatureTrackFilter_IsYourChild_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsYourChild_C");

	return Clss;
}


// CreatureTrackFilter_IsYourChild_C CreatureTrackFilter_IsYourChild.Default__CreatureTrackFilter_IsYourChild_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsYourChild_C* UCreatureTrackFilter_IsYourChild_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsYourChild_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsYourChild_C*>(UCreatureTrackFilter_IsYourChild_C::StaticClass()->DefaultObject);
...
// bool                               CallFunc_IsImprintPlayer_ReturnValue                             (Edit, ConstParm, ExportObject, BlueprintReadOnly, EditFixedSize, OutParm, ReturnParm, DisableEditOnInstance, EditConst, InstancedReference, SubobjectReference)
// bool                               CallFunc_BooleanAND_ReturnValue                                  (Edit, BlueprintVisible, ExportObject, EditFixedSize, ZeroConstructor, ReturnParm, Config, SubobjectReference)

bool UCreatureTrackFilter_IsYourChild_C::ShouldActorBeTracked(class AActor** InvestigatedActor, int32 CustomTameSelectionType, int32 DinoGroup, const class FString& CustomTameSearchText, class AShooterGameMode* GameMode, class AShooterCharacter** Requesting_player_Shooter_Character, bool* Debug_Enabled, bool Handled, bool* Ret_should_show, bool* CallFunc_ShouldActorBeTracked_Handled, bool* CallFunc_ShouldActorBeTracked_ReturnValue, class APrimalDinoCharacter** K2Node_DynamicCast_AsPrimal_Dino_Character, bool* K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CreatureTrackFilter_IsYourChild_C", "ShouldActorBeTracked");

	Params::UCreatureTrackFilter_IsYourChild_C_ShouldActorBeTracked_Params Parms{};
