...
class UClass* UPrimalItem_WeaponSprayPaint_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalItem_WeaponSprayPaint_C");

	return Clss;
}


// PrimalItem_WeaponSprayPaint_C PrimalItem_WeaponSprayPaint.Default__PrimalItem_WeaponSprayPaint_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrimalItem_WeaponSprayPaint_C* UPrimalItem_WeaponSprayPaint_C::GetDefaultObj()
{
	static class UPrimalItem_WeaponSprayPaint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrimalItem_WeaponSprayPaint_C*>(UPrimalItem_WeaponSprayPaint_C::StaticClass()->DefaultObject);
...
// class UTexture2D*                  CallFunc_GetIconForKeyName_ReturnValue_4                         (ExportObject, BlueprintReadOnly, Net, OutParm, ZeroConstructor, Transient, Config, SubobjectReference, RepNotify, NonTransactional)
// class FString                      CallFunc_FormatTextureAsRichText_ReturnValue_4                   (ConstParm, ExportObject, EditFixedSize, Parm, OutParm, Config, DisableEditOnInstance, EditConst, InstancedReference, SubobjectReference, RepNotify, NonTransactional)
...
class FString UPrimalItem_WeaponSprayPaint_C::BPGetItemDescription(class AShooterPlayerController** ForPC, bool CallFunc_BPGetGlobalUIData_bIsPsOrXbUi, class UPrimalGlobalUIData** CallFunc_BPGetGlobalUIData_ReturnValue, class UTexture2D** CallFunc_GetIconForKeyName_ReturnValue, class UTexture2D** CallFunc_GetIconForKeyName_ReturnValue_1, class FString* CallFunc_FormatTextureAsRichText_ReturnValue, class FString* CallFunc_FormatTextureAsRichText_ReturnValue_1, struct FFormatArgumentData* K2Node_MakeStruct_FormatArgumentData, struct FFormatArgumentData* K2Node_MakeStruct_FormatArgumentData_1, class UTexture2D** CallFunc_GetIconForKeyName_ReturnValue_2, class UTexture2D** CallFunc_GetIconForKeyName_ReturnValue_3, class FString* CallFunc_FormatTextureAsRichText_ReturnValue_2, class FString* CallFunc_FormatTextureAsRichText_ReturnValue_3, struct FFormatArgumentData* K2Node_MakeStruct_FormatArgumentData_2, struct FFormatArgumentData* K2Node_MakeStruct_FormatArgumentData_3, class UTexture2D** CallFunc_GetIconForKeyName_ReturnValue_4, class FString* CallFunc_FormatTextureAsRichText_ReturnValue_4, struct FFormatArgumentData* K2Node_MakeStruct_FormatArgumentData_4, TArray<struct FFormatArgumentData>* K2Node_MakeArray_Array)
{
	...
	Params::UPrimalItem_WeaponSprayPaint_C_BPGetItemDescription_Params Parms{};
	...
	if (CallFunc_GetIconForKeyName_ReturnValue_4 != nullptr)
		*CallFunc_GetIconForKeyName_ReturnValue_4 = Parms.CallFunc_GetIconForKeyName_ReturnValue_4;

	if (CallFunc_FormatTextureAsRichText_ReturnValue_4 != nullptr)
		*CallFunc_FormatTextureAsRichText_ReturnValue_4 = std::move(Parms.CallFunc_FormatTextureAsRichText_ReturnValue_4);
