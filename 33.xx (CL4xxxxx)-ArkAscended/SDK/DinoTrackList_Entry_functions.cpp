...
class UClass* UDinoTrackList_Entry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DinoTrackList_Entry_C");

	return Clss;
}


// DinoTrackList_Entry_C DinoTrackList_Entry.Default__DinoTrackList_Entry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDinoTrackList_Entry_C* UDinoTrackList_Entry_C::GetDefaultObj()
{
	static class UDinoTrackList_Entry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDinoTrackList_Entry_C*>(UDinoTrackList_Entry_C::StaticClass()->DefaultObject);
...
void UDinoTrackList_Entry_C::OnPaint(struct FPaintContext* Context, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool CallFunc_IsHovered_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	...
	Params::UDinoTrackList_Entry_C_OnPaint_Params Parms{};
