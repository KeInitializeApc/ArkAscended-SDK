...
public:
	...
	uint8                                        Pad_28E0[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class APrimalDinoCharacter*                  CallFunc_GetFirstValidWildFollowingParentRef_ReturnValue; // 0x38(0x8)(BlueprintVisible, EditFixedSize, Parm, OutParm, ReturnParm, DisableEditOnTemplate, Transient, Config, EditConst, SubobjectReference)
