...
public:
	...
	uint8                                        Pad_3976[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_397B[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class APrimalDinoCharacter*                  CallFunc_GetFirstValidWildFollowingParentRef_ReturnValue; // 0x38(0x8)(ConstParm, BlueprintVisible, ExportObject, Net, EditFixedSize, OutParm, DisableEditOnTemplate, Transient, Config, GlobalConfig, SubobjectReference)
