...
public:
	...
	uint8                                        Pad_2250[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_2251[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	...
	class AActor*                                CallFunc_GetTamedLandTarget_ReturnValue;           // 0x40(0x8)(ConstParm, BlueprintVisible, ExportObject, Net, EditFixedSize, OutParm, ReturnParm, DisableEditOnTemplate, Config, DisableEditOnInstance, GlobalConfig, SubobjectReference)
	...
	bool                                         CallFunc_IsValid_ReturnValue_1;                    // 0x49(0x1)(Edit, Parm, ReturnParm, DisableEditOnTemplate, Transient, Config, SubobjectReference, Interp)
	bool                                         CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x4A(0x1)(Edit, ConstParm, OutParm, ReturnParm, DisableEditOnTemplate, EditConst, SubobjectReference)
};
