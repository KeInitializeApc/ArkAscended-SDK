...
class UClass* UCreatureTrackFilter_IsWaterDino_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_IsWaterDino_C");

	return Clss;
}


// CreatureTrackFilter_IsWaterDino_C CreatureTrackFilter_IsWaterDino.Default__CreatureTrackFilter_IsWaterDino_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_IsWaterDino_C* UCreatureTrackFilter_IsWaterDino_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_IsWaterDino_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_IsWaterDino_C*>(UCreatureTrackFilter_IsWaterDino_C::StaticClass()->DefaultObject);
