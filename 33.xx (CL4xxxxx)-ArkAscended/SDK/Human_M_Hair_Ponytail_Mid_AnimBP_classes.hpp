...
{
public:
	uint8                                        Pad_4B7E[0x8];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_4B82[0x5];                                     // Fixing Size After Last Property  > TateDumper <
	...
	double                                       DefaultGravity;                                    // 0x10C0(0x8)(Edit, ExportObject, EditFixedSize, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	double                                       UnderwaterGravity;                                 // 0x10C8(0x8)(Edit, ConstParm, Net, Parm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, InstancedReference, SubobjectReference)
	bool                                         Swimming;                                          // 0x10D0(0x1)(ExportObject, EditFixedSize, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, SubobjectReference)
	...
	class UMaterialParameterCollection*          MaterialCollectionParameter;                       // 0x1100(0x8)(Edit, BlueprintReadOnly, Net, Parm, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, InstancedReference, SubobjectReference)
