...
{
public:
	struct FPropertyPathTestStruct               InStruct;                                          // 0x0(0x50)(BlueprintVisible, ExportObject, Parm, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, SubobjectReference)
};
...
{
public:
	struct FPropertyPathTestStruct               ReturnValue;                                       // 0x0(0x50)(BlueprintVisible, ExportObject, OutParm, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, EditConst, SubobjectReference)
};
