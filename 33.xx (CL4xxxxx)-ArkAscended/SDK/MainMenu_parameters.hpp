...
public:
	...
	uint8                                        Pad_2E3C[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_2E3D[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	class UReMainMenuUI_ASA_C*                   CallFunc_Create_ReturnValue;                       // 0x20(0x8)(Edit, ExportObject, BlueprintReadOnly, EditFixedSize, Parm, OutParm, ZeroConstructor, ReturnParm, DisableEditOnTemplate, Transient, EditConst, SubobjectReference)
};
