...
public:
	...
	uint8                                        Pad_4F51[0x4];                                     // Fixing Size After Last Property  > TateDumper <
	...
	uint8                                        Pad_4F52[0x7];                                     // Fixing Size After Last Property  > TateDumper <
	class UReMainMenuUI_ASA_C*                   CallFunc_Create_ReturnValue;                       // 0x20(0x8)(Net, EditFixedSize, ZeroConstructor, DisableEditOnTemplate, Transient, Config, DisableEditOnInstance, SubobjectReference)
};
