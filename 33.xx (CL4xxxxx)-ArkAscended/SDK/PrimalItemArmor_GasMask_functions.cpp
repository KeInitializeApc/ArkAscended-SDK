...
class UClass* UPrimalItemArmor_GasMask_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrimalItemArmor_GasMask_C");

	return Clss;
}


// PrimalItemArmor_GasMask_C PrimalItemArmor_GasMask.Default__PrimalItemArmor_GasMask_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrimalItemArmor_GasMask_C* UPrimalItemArmor_GasMask_C::GetDefaultObj()
{
	static class UPrimalItemArmor_GasMask_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrimalItemArmor_GasMask_C*>(UPrimalItemArmor_GasMask_C::StaticClass()->DefaultObject);
...
bool UPrimalItemArmor_GasMask_C::BlueprintEquipped()
{
	...
	Params::UPrimalItemArmor_GasMask_C_BlueprintEquipped_Params Parms{};
...
class APrimalBuff* UPrimalItemArmor_GasMask_C::ExecuteUbergraph_PrimalItemArmor_GasMask(int32* EntryPoint, class AActor* CallFunc_GetOwner_ReturnValue, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character, bool* K2Node_DynamicCast_bSuccess, class APrimalCharacter** K2Node_DynamicCast_AsPrimal_Character_1, bool* K2Node_DynamicCast_bSuccess_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPrimalItemArmor_GasMask_C_ExecuteUbergraph_PrimalItemArmor_GasMask_Params Parms{};
