...
void UUI_CustomizeSlot_BUTTON_SignIn_C::SetColor(struct FLinearColor* Color, bool* CallFunc_IsValid_ReturnValue)
{
...
void UUI_CustomizeSlot_BUTTON_SignIn_C::GetColor(struct FLinearColor* Color, struct FCFCoreThemeRowData* CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
