...
class UClass* UCreatureTrackFilter_Any_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureTrackFilter_Any_C");

	return Clss;
}


// CreatureTrackFilter_Any_C CreatureTrackFilter_Any.Default__CreatureTrackFilter_Any_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureTrackFilter_Any_C* UCreatureTrackFilter_Any_C::GetDefaultObj()
{
	static class UCreatureTrackFilter_Any_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureTrackFilter_Any_C*>(UCreatureTrackFilter_Any_C::StaticClass()->DefaultObject);
